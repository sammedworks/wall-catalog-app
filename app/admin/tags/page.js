                      ...
                      {categoryTags.map((tag) => (
                        <tr key={tag.id} className="hover:bg-gray-50">
                          <td className="px-6 py-4">
                            <div className="inline-flex px-4 py-2 rounded-full text-sm font-medium bg-gray-100 text-gray-900">
                              {tag.name}
                            </div>
                          </td>
                          <td className="px-6 py-4">
                            <span className="text-sm text-gray-700">{tag.display_order}</span>
                          </td>
                          <td className="px-6 py-4">
                            <button
